...
use self::tesseract_sys::{
    ...
    TessBaseAPISetPageSegMode, TessBaseAPISetRectangle,
...
impl TessBaseApi {
    ...
    /// tess_page_seg_mode: tesseract_sys::TessPageSegMode_{HOGE}
    /// this parameter is "tesseract_layout" for python
    pub fn set_page_seg_mode(&mut self, tess_page_seg_mode: TessPageSegMode) {
        unsafe {
            TessBaseAPISetPageSegMode(self.0, tess_page_seg_mode)
        }
    }
